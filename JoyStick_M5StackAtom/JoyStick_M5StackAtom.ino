...
String MACadd = "B8:F0:09:C5:24:FE";
uint8_t address[6]  = {0xB8, 0xF0, 0x09, 0xC5, 0x24, 0xFE};
String name = "OBDII";
...
void loop() {
  int16_t speed1 = map(analogRead(33), 0, 4095, -255, 255);
  int16_t speed2 = map(analogRead(25), 0, 4095, -255, 255);
